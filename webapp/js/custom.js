...
$("#predict").click(function(){
  ...
  var radioValue = $("input[name='materialExampleRadios']:checked").val();

  var data = {url: url, option: radioValue}

  // Post url to python script
  var jq = $.post('cgi-bin/mnist.py', data)
    .done(function (json) {
      if (json.result) {
        $("#status").removeClass().toggleClass("fa fa-check");
        $("#result_equation").text(json.equation);
      } else {
